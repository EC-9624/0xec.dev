...
type MockService struct {
	...
	GetBoardViewDataFunc           func(ctx context.Context, recentLimit int) (*BoardViewData, error)
...
func (m *MockService) GetBoardViewData(ctx context.Context, recentLimit int) (*BoardViewData, error) {
